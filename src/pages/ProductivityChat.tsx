...
const ProductivityChat: React.FC = () => {
  ...
  const handleMessage = async (message: string): Promise<MessageResponse> => {
  ...
  const handleTaskCreation = async (message: string): Promise<MessageResponse> => {
    try {
  ...
  const handleChallengeGeneration = async (message: string): Promise<MessageResponse> => {
    try {
  ...
  const handleGeneralQuery = async (message: string): Promise<MessageResponse> => {
    try {
