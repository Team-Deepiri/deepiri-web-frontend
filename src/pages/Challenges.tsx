...
const Challenges: React.FC = () => {
  ...
  const generateChallenge = async (taskId: string): Promise<void> => {
    try {
      const token = localStorage.getItem('token');
  ...
  const completeChallenge = async (challengeId: string, completionData: any): Promise<void> => {
    try {
      const token = localStorage.getItem('token');
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="p-4 bg-gradient-to-r from-cyan-400/20 to-cyan-500/20 rounded-lg">
                  ...
                  <div className="text-lg font-bold text-cyan-300">{selectedChallenge.pointsReward || 0} pts</div>
                </div>
              </div>
