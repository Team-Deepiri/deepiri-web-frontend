...
const AdventureHistory: React.FC = () => {
  const { user } = useAuth();
  ...
  const loadAdventures = async (): Promise<void> => {
    try {
      setLoading(true);
  ...
  const getAdventureStats = () => {
    ...
    const totalTime = adventures.reduce((sum, a) => sum + (a.totalDuration || 0), 0);
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <div className="font-medium">{adventure.steps?.length || 0}</div>
                      </div>
                      <div>
