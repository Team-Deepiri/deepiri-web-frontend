...
const Privacy: React.FC = () => {
  return (
    <div className="container px-4 py-5">
      <h1 className="font-black" style={{ color: "#000000", fontSize: "clamp(28px, 3.2vw, 44px)" }}>
        Privacy Policy
      </h1>

      <p style={{ color: "#575d68", maxWidth: 900, lineHeight: 1.7 }}>
      ...
      >
        <h2 className="font-black" style={{ color: "#000000", fontSize: 22 }}>
          Privacy-first principles
        </h2>
        <ul style={{ color: "#575d68", lineHeight: 1.9, marginTop: 10 }}>
