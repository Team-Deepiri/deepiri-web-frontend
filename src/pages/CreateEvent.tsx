          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('startTime', e.target.value)}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('endTime', e.target.value)}
                  className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('location.address', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('maxParticipants', parseInt(e.target.value))}
                className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
