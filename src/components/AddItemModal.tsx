...
const AddItemModal: React.FC<AddItemModalProps> = ({ isOpen, onClose, onSubmit, initialData = null }) => {
  ...
  const handleInputChange = (field: keyof ItemFormData, value: any): void => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const handleNestedInputChange = (parent: 'value' | 'properties' | 'acquiredLocation', field: string, value: any): void => {
    setFormData(prev => ({
      ...prev,
      [parent]: {
        ...prev[parent],
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e: ChangeEvent<HTMLSelectElement>) => handleInputChange('rarity', e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('value', 'points', parseInt(e.target.value) || 0)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('value', 'coins', parseInt(e.target.value) || 0)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
                  placeholder="0"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('value', 'monetaryValue', parseFloat(e.target.value) || 0)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
                  placeholder="0.00"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('properties', 'color', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('properties', 'size', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('properties', 'material', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e: ChangeEvent<HTMLSelectElement>) => handleNestedInputChange('properties', 'condition', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e: ChangeEvent<HTMLSelectElement>) => handleInputChange('source', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('sourceName', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('acquiredLocation', 'address', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleNestedInputChange('acquiredLocation', 'venue', e.target.value)}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors"
            ...
            <div className="space-y-3">
              <label className="flex items-center gap-3 cursor-pointer">
                <input
                  ...
                  onChange={(e: ChangeEvent<HTMLInputElement>) => handleInputChange('isFavorite', e.target.checked)}
