...
class VirtualEnvironmentService {
  ...
  private weatherSystems: Record<string, WeatherSystem> = {
  ...
  private timeOfDay: string = "day"; // day, sunset, night, dawn

  /**
   * Get available environments
   */
  getAvailableEnvironments(): Array<{ id: string } & EnvironmentConfig> {
   ...
   */
  setEnvironment(environmentId: string, options: { weather?: string; timeOfDay?: string; customizations?: Record<string, any> } = {}): Environment | null {
  ...
  getCurrentEnvironment(): Environment {
    return this.currentEnvironment || {
      id: 'default',
      config: this.environments.futuristic_race_track,
      weather: 'sunny',
   ...
   */
  getEnvironmentBonus(challengeType: string): number {
   ...
   */
  unlockEnvironment(environmentId: string): boolean {
