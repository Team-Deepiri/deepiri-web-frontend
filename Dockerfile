...
ARG VITE_API_URL
ARG VITE_API_GATEWAY_URL=http://localhost:5100
ARG VITE_REGISTRY_URL=http://localhost:5003
ARG VITE_REALTIME_GATEWAY_URL=http://localhost:5008
...
ENV VITE_API_URL=$VITE_API_URL \
    ...
    VITE_REALTIME_GATEWAY_URL=$VITE_REALTIME_GATEWAY_URL \
